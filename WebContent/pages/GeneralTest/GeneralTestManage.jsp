	...
	<body>
		...
		<blockquote class="layui-elem-quote">
			<div class="layui-upload">
				...
				<!--<button type="button" class="layui-btn layui-btn-normal" id="btghtdcexl">不通过后台导入Excel</button>-->
		...
		<fieldset class="layui-elem-field">
			...
			<script type="text/html" id="examinationStatusTpl">
				{{# if(d.examinationStatus == '11'){ }}
				<span style="color: #0000CC;">审核中</span> {{# }else if(d.examinationStatus == '12'){ }}
				<span style="color: #ff0000;">审核没通过</span> {{# }else if(d.examinationStatus == '13'){ }}
			...
			<script type="text/html" id="photoTpl">
				<img src="{{d.photoPth}}" style="widows: 100%; height: 100%;" />
			</script>
			<!--	描述：控制按钮 -->
	...
	<script>
		...
		layui.use(['table', 'form'], function() {
			...
			var tableIns = table.render({
				...
				method: 'post',
				url: '/EnglishTestController/findGeneralTest',
				width: 1000
					//,height: 274
					,
				cols: [
...
//					});
					...
					table.on('tool(wskximgNameManage)', function(obj) {
						...
						if(obj.event === 'del') {
							...
							location.href = 'GeneralTestUpdata.jsp?id=' + data.id;
						} else if(obj.event === 'fail') {
							location.href = 'GeneralTestFail.jsp?id=' + data.id + "&examinationStatus=" + data.examinationStatus;
			...
			$("#export").on("click", function() {
				var url = '/EnglishTestController/export?examination=' + examination + '&st1=11&st2=13';
