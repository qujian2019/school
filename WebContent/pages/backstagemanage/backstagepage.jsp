...
<html>
	...
	<body>
		<div class="layui-layout layui-layout-admin">
			<div class="layui-header">
				<div class="layui-logo">湖南工商职业学院</div>
				<!-- 头部区域（可配合layui已有的水平导航） -->
				<ul class="layui-nav layui-layout-left">
					<!--<li class="layui-nav-item"><a href="">控制台</a></li>-->
					<!--<li class="layui-nav-item"><a href="">商品管理</a></li>-->
					<!--			<li class="layui-nav-item">
					<a href="usermanagement.jsp">用户管理</a> window.onbeforeunload= function(event) { return confirm("确定离开此页面吗？"); }
				</li>-->    
					<!--				<li class="layui-nav-item"><a href="javascript:;">其它系统</a>
					<dl class="layui-nav-child">  onbeforeunload="window.location='<%=request.getContextPath()%>/logout'"
						<dd>
							<a href="">邮件管理</a>
						</dd>
						<dd>
	...
	<script>
		...
		$("#newRelease").on("click", function() {
			$("#mianIframe").attr("src", "<%=request.getContextPath()%>/goNews");
		});
