			...
			<div class="basbox">
				<form class="layui-form" action="">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="userPhone" type="text" name="userPhone" required lay-verify="required|phone" placeholder="请输入电话号码" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">性别</label>
						<div class="layui-input-block" id='tihuan'>
							<!--<input type="radio" id="sex1" name="userGender" value="男" title="男">
			     <input type="radio" id="sex2" name="userGender" value="女" title="女">-->
						</div>
					</div>
					<div class="layui-form-item">
	...
	<script>
		var ref = {
			tihuan: {
				html: function() {
					var man, nv = "";
					(this.tihuan == "男") ? man = "checked": nv = "checked";

					return '<input type="radio" id="sex1" name="userGender" value="男" title="男" ' + man + '><input type="radio" id="sex2" name="userGender" value="女" title="女" ' + nv + '>';
				}
			}
		};
		$(function() {
			$.ajax({
				...
				success: function(data) {
					if(data) {
						data['tihuan'] = data.userGender;
						delete data.userGender;
						$('.layui-form').render(data, ref);
						//Demo
