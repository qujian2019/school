			...
			<form class="layui-form" action="" name="form1">
				<div class="layui-form-item">
					...
					<div class="layui-input-block inputleft" style="margin-left: 1px;">
						<input type="text" name="workName" lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input" id="workName">
					</div>
					<label class="layui-form-label inputleft">部门名称:</label>
					<div class="layui-input-block inputleft" style="margin-left: 1px;">
						<input type="text" name="deptName" lay-verify="required" placeholder="请输入部门名称" autocomplete="off" class="layui-input" id="deptName">
					</div>
		...
		<table class="layui-table">
			<tbody>
				...
				<tr>
					...
					<td><textarea name="jobContent1" id="jobContent1" lay-verify="" placeholder="请输入工作内容" class="layui-textarea"></textarea></td>
				</tr>
				<tr>
					<td><input type="text" name="timeSlot2" id="timeSlot2" lay-verify="" placeholder="请输入时间" autocomplete="off" class="layui-input"></td>
					<td><textarea name="jobContent2" id="jobContent2" lay-verify="" placeholder="请输入工作内容"  class="layui-textarea"></textarea></td>

				</tr>
				<tr>
					<td><input type="text" name="timeSlot3" id="timeSlot3" lay-verify="" placeholder="请输入时间" autocomplete="off" class="layui-input"></td>
					<td><input  name="jobContent3" id="jobContent3" lay-verify="" placeholder="请输入工作内容"  class="layui-textarea"></textarea></td>
				</tr>
				<tr>
					<td><input type="text" name="timeSlot4" id="timeSlot4" lay-verify="" placeholder="请输入时间" autocomplete="off" class="layui-input"></td>
					<td><textarea name="jobContent4" id="jobContent4" lay-verify="" placeholder="请输入工作内容" class="layui-textarea"></textarea></td>

				</tr>
				<tr>
					<td><input type="text" name="timeSlot5" id="timeSlot5" lay-verify="" placeholder="请输入时间" autocomplete="off" class="layui-input"></td>
					<td><textarea name="jobContent5" id="jobContent5" lay-verify="" placeholder="请输入工作内容"  class="layui-textarea"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					<td rowspan="10" width="20px">今日未完成工作</td>
					<td colspan="2">尚未完成的工作</td>
				</tr>
				<tr>
			...
			$.ajax({
				...
				success: function(data) {
					...
					setTimeout(function() {
						...
						$("#commonly").val(data.commonly);
						$("#timeSlot1").val(data.timeSlot1);
						$("#timeSlot2").val(data.timeSlot2);
						$("#timeSlot3").val(data.timeSlot3);
						$("#timeSlot4").val(data.timeSlot4);
						$("#timeSlot5").val(data.timeSlot5);
						$("#jobContent1").val(data.jobContent1);
						$("#jobContent2").val(data.jobContent2);
						$("#jobContent3").val(data.jobContent3);
						$("#jobContent4").val(data.jobContent4);
						$("#jobContent5").val(data.jobContent5);
						$("#completeTime1").val(data.completeTime1);
						$("#completeTime2").val(data.completeTime2);
						$("#completeTime3").val(data.completeTime3);
						$("#completeTime4").val(data.completeTime4);
						$("#completeTime5").val(data.completeTime5);
						$("#ratifiedTime1").val(data.ratifiedTime1);
						$("#ratifiedTime2").val(data.ratifiedTime2);
						$("#ratifiedTime3").val(data.ratifiedTime3);
						$("#ratifiedTime4").val(data.ratifiedTime4);
						$("#ratifiedTime5").val(data.ratifiedTime5);
						$("#selfVerification").val(data.selfVerification);
						$("#personnelVerification").val(data.personnelVerification);
						$("#notCompleted").val(data.notCompleted);
						$("#problem").val(data.problem);
						$("#Improvement").val(data.improvement);
						$("#leadershipVerification").val(data.leadershipVerification);
					}, 666);
				}
			});
		}
