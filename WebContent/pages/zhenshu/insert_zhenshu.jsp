			...
			$(function(){
					...
					if(id == null || id == '' || id == undefined ){}else{
						$.ajax({
								...
								success: function(data) {
									//console.log(data)
									$("#title").val(data.title);$("#content").val(data.content);
									$("#idcard").val(data.idcard);$("#adddate").val(data.adddate);
									$("#data").val(data.data);$("#birthday").val(data.birthday);
									$("#classid").val(data.classid);$("#studentImg").val(data.pic);
									$("#sex1").attr('checked','');
									$("#sex2").attr('checked','');
									if(data.sex == '1'){
