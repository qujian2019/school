package com.hngsxy.web.biz.news;
...
public interface NewsBiz {
	//用户查询新闻
	ArrayList<News> findNews(News news,int page, int limit,String[] temp0) throws Exception;
	//新闻总数
	Integer findNewsTotal(News news,String[] temp0)throws Exception;
	//校园办公室审核新闻信息
	ArrayList<News> findSchoolOfficeAudit(News news,int page, int limit)throws Exception;
	//校园办公室审核新闻信息
	Integer findSchoolOfficeAuditTotal(News news)throws Exception;
	//发布新闻
	...
	//批量删除新闻
	Integer updateNewsState(String[] newsIds)throws Exception;
	//修改一条新闻
	...
	ArrayList<News> findNewsTypes(String[] newTypes)throws Exception;
	//查询新闻可以用新闻的newType 一个或多个
	ArrayList<News> findNewsTypes2(String[] newTypes)throws Exception;
	//修改排序
